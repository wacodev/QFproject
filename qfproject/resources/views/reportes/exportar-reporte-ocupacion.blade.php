...
@section('titulo', 'Reportes | Ocupación de locales')
...
@section('subencabezado', 'Ocupación de locales')
...
@section('contenido')
    <div class="box box-success">
        ...
        {!! Form::open(['route' => 'reportes.reporte-ocupacion', 'autocomplete' => 'off', 'method' => 'POST', 'class' => 'form-horizontal']) !!}
            <div class="box-body">
...
@section('sidebar')
    ...
    @include('reportes.partials.info-prolocal')
@endsection
