        ...
        <div class="col-md-8">
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    {!! Form::open(['route' => ['actividades.update', $actividad], 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
                        {{ Form::token() }}
                        <div class="box-body">
                            <div class="form-group">
                                {!! Form::label('nombre', 'Nombre', ['class' => 'col-sm-2 control-label']) !!}
                                <div class="col-sm-10">
                                    {!! Form::text('nombre', $actividad->nombre, ['class' => 'form-control', 'placeholder' => 'Nombre de la actividad']) !!}
