        ...
        <div class="col-md-8">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Exportar datos</h3>
                </div>
                {!! Form::open(['route' => 'reservaciones.recibir', 'autocomplete' => 'off', 'method' => 'POST', 'class' => 'form-horizontal']) !!}
                    <div class="box-body">
                        <div class="form-group{{ $errors->has('fecha') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                <input name="fecha" type="text" class="form-control pull-right" id="reservation" required="true">
                                @if ($errors->has('fecha'))
                        ...
                        <div class="form-group{{ $errors->has('local_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                ...
                                @if ($errors->has('local_id'))
                                    <span class="help-block">
                                        <i class="fa fa-exclamation-triangle icono-margen" aria-hidden="true"></i>{{ $errors->first('local_id') }}
                                    </span>
                                @endif
                            </div>
                        </div>
